(function () {
  'use strict';
    ...
    fleximeta.model.Family = function (options) {
        ...
        fleximeta.model.Base.call(this, {
    ...
    fleximeta.model.Family.prototype.set = function (key, value) {
        if (typeof key === 'object') {
            fleximeta.model.Base.prototype.set.call(this, key, value);
            return;
        }
...
(function () {
  'use strict';
    ...
    fleximeta.model.Individual.prototype.set = function (key, value) {
        if (typeof key === 'object') {
            fleximeta.model.Base.prototype.set.call(this, key, value);
            return;
        }
